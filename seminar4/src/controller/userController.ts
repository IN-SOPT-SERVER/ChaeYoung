...
import { UserSignInDTO } from "../interfaces/UserSingInDTO";
...
const getAllUser = async (req: Request, res: Response) => {
  ...
  return res
    .status(sc.OK)
    .json({ status: sc.OK, message: rm.READ_ALL_USERS_SUCCESS, data });
};
...
const updateUser = async (req: Request, res: Response) => {
  ...
  if (!userName)
    return res
      .status(sc.BAD_REQUEST)
      .json({ status: sc.BAD_REQUEST, message: rm.UPDATE_USER_FAIL });
  ...
  return res
    .status(sc.OK)
    .json({ status: sc.OK, message: rm.UPDATE_USER_SUCCESS, data });
};
...
const getUserById = async (req: Request, res: Response) => {
  ...
  if (!data) {
    return res
      .status(sc.NOT_FOUND)
      .json({ status: sc.NOT_FOUND, message: rm.NOT_FOUND });
  }
  return res
    .status(sc.OK)
    .json({ status: sc.OK, message: rm.READ_USER_SUCCESS, data });
};
